...
const App = () => {
  ...
  return (
    <Stage width={window.innerWidth} height={window.innerHeight}  >
      <Layer>
        <Group draggable height={chartDetails.graphHeight} width={chartDetails.graphWidth} x={chartDetails.graphCoordX}
          y={chartDetails.graphCoordY} onDragStart={onMouseOut} ref={groupRef}>
          {chartDetails.dataSet.map((rect, idx) =>
            <Rectangle graphHeight={chartDetails.graphHeight}
              padding={chartDetails.padding} xScale={xScale} yScale={yScale}
              onMouseOver={onMouseOver} onMouseOut={onMouseOut} item={rect} i={idx} key={idx} />
          )}
          <Arrow
          ...
          {chartDetails.dataSet.map((rect, idx) => <ScaleValues key={idx} i={idx} graphWidth={chartDetails.graphWidth}
            graphHeight={chartDetails.graphHeight} dataSet={chartDetails.dataSet} topValue={chartDetails.topValue} padding={chartDetails.padding}
            months={chartDetails.horiArrow.label} xScale={chartDetails.xScale}
          />)}
        </Group>
