    ...
    <Stage width={window.innerWidth} height={window.innerHeight} ref={stageRef} >
      <Layer class="graphLayer">
        <Group draggable height={chartDetails.graphHeight} width={chartDetails.graphWidth} x={chartDetails.graphCoordX} y={chartDetails.graphCoordY} >
          <Rectangle graphWidth={chartDetails.graphWidth} graphHeight={chartDetails.graphHeight} inputs={chartDetails.dataSet} months={chartDetails.horiArrow.label} onMouseOver={onMouseOver} onMouseOut={onMouseOut} />
          <Arrow
