...
const App = () => {
  ...
  let initialValues = {
    ...
    horiArrow: {
      ...
      xAxis: 0,
      yAxis: (graphWidth > 300 ? graphHeight / 1.7 : graphHeight / 1.2),
      direction: -90,
      label: months
    },
    dataSet: inputs,
      ...
      <Layer class="graphLayer">
        <Group draggable height={chartDetails.graphHeight} width={chartDetails.graphWidth} x={chartDetails.graphCoordX} y={chartDetails.graphCoordY} >
          ...
          <Arrow
            ...
            stroke={chartDetails.line.stroke}
          />
          <Text text="dfd" fontSize={chartDetails.horiArrow.fontSize} x={chartDetails.horiArrow.xAxis} y={chartDetails.horiArrow.yAxis} rotation={chartDetails.horiArrow.direction} />
          <Text text={chartDetails.vertArrow.desc} fontSize={chartDetails.vertArrow.fontSize} align="center" y={chartDetails.vertArrow.yAxis} />
        </Group>
