...
const App = () => {
  ...
  const onMouseOver = (e) => {
    ...
    console.log(stageRef.current.getPointerPosition().x + " " + stageRef.current.getPointerPosition().y);
  ...
  return (
    <Stage width={window.innerWidth} height={window.innerHeight}  >
      <Layer>
        <Group draggable height={chartDetails.graphHeight} width={chartDetails.graphWidth} x={chartDetails.graphCoordX} y={chartDetails.graphCoordY} onDragStart={onMouseOut} ref={stageRef}>
