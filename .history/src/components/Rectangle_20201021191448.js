...
const Rectangle = ({ graphWidth, graphHeight, padding, topValue,
    ...
    return (
        ...
        />, <Text key={-i - 1} text={i < 10 ? i * Math.ceil(Math.floor(topValue * 1.2 / 10) * 10 / inputs.length) : null} fontSize={15} x={padding / 2} y={graphHeight - padding - i * ((graphHeight - padding) / (inputs.length - 2.9))} />,
