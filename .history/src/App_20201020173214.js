...
const App = () => {
  ...
  const onMouseOver = (e) => {
    var mousePos = stateRef.current.getPointerPosition();
  ...
  return (
    <Stage width={window.innerWidth} height={window.innerHeight} id="stage" ref={stateRef}>
      <Layer>
        <Group draggable width={700} height={700}>
