    ...
    <Stage width={window.innerWidth} height={window.innerHeight} ref={stageRef} >
      <Layer>
        <Group draggable>
          ...
          <Text text={chartDetails.horiArrow.desc} fontSize={chartDetails.vertArrow.fontSize} x={chartDetails.vertArrow.xAxis} y={chartDetails.vertArrow.yAxis} rotation={-35} />
        </Group>
      </Layer>
      <Tooltip />
    </Stage>
